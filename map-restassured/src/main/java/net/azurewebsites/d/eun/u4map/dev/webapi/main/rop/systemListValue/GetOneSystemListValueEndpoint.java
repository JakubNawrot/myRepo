...
public class GetOneSystemListValueEndpoint extends BaseEndPoint<GetOneSystemListValueEndpoint, SystemListValue> {
    private String id;

    public GetOneSystemListValueEndpoint setId(String id) {
        this.id = id;
        return this;
    }
    ...
    @Override
    public GetOneSystemListValueEndpoint sendRequest() {
        response = given().spec(RequestConfigurationBuilder.getDefaultRequestSpecification())
                    .pathParam("tenantId", tenantId)
                    .pathParam("id", id)
                .when()
                    .get("SystemListValue/{tenantId}/{id}");
        return this;
    }
